...
GLuint Shader::CreateProgramFromFiles(const std::string& vertex_shader, const std::string& fragment_shader) {
...
GLuint Shader::CreateProgramFromSources(const std::string& vertex_shader, const std::string& fragment_shader) {
