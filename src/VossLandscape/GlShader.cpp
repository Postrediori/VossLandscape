...
std::string GlShader::showShaderError(GLuint shader) {
    GLint blen = 0;
    GLsizei slen = 0;
    std::stringstream str;
...
std::string GlShader::showShaderInfo(GLuint shader) {
    int length;
    std::stringstream str;
...
bool GlShader::createProgram(GLuint& program, GLuint& vertex, GLuint& fragment,
...
bool GlShader::createProgramSource(
    GLuint& program, GLuint& vertex, GLuint& fragment,
    const std::string& vertex_shader, const std::string& fragment_shader) {
...
void GlShader::releaseProgram(GLuint program, GLuint vertex, GLuint fragment) {
    if (program) {
        if (vertex) {
